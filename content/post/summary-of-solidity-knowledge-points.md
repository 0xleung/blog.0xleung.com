...
##### [](#1-1-4-地址类型 "1.1.4    地址类型")1.1.4 地址类型
...
### [](#2-内置的变量和函数 "2.内置的变量和函数")2.内置的变量和函数
...
##### [](#2-3-6-合约相关 "2.3.6    合约相关")2.3.6 合约相关
...
##### [](#3-4-4-fallback "3.4.4 fallback")3.4.4 fallback
